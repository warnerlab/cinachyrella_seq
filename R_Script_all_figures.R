...
write.table(results(res, contrast=c("Condition", "control", "oil_1")), file="control_vs_O1_test.txt", sep="\t", quote=F)
write.table(results(res, contrast=c("Condition", "control", "oil_24")), file="control_vs_O24_test.txt", sep="\t", quote=F)
write.table(results(res, contrast=c("Condition", "control", "dispersant_1")), file="control_vs_D1_test.txt", sep="\t", quote=F)
write.table(results(res, contrast=c("Condition", "control", "dispersant_24")), file="control_vs_D24_test.txt", sep="\t", quote=F)
write.table(results(res, contrast=c("Condition", "control", "oil_dispersant_1")), file="control_vs_OD1_test.txt", sep="\t", quote=F)
write.table(results(res, contrast=c("Condition", "control", "oil_dispersant_24")), file="control_vs_OD24_test.txt", sep="\t", quote=F)
write.table(results(res, contrast=c("Condition", "oil_1", "oil_24")), file="O1_vs_O24_test.txt", sep="\t", quote=F)
write.table(results(res, contrast=c("Condition", "dispersant_1", "dispersant_24")), file="D1_vs_D24_test.txt", sep="\t", quote=F)
write.table(results(res, contrast=c("Condition", "oil_dispersant_1", "oil_dispersant_24")), file="OD1_vs_OD24_test.txt", sep="\t", quote=F)
